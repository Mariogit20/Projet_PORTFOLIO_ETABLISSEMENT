...
SECRET_KEY = 'django-insecure-n!z^$ppfbzzv8#@x6@+j($f64on53#z=p_e%8v8#*@_ninpbu2'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],
        'APP_DIRS': True, # Indispensable pour trouver le dossier "templates"
        'OPTIONS': {
            'context_processors': [
...
# --- MODIFICATIONS POUR LE FRANÇAIS ET LE FUSEAU HORAIRE ---
LANGUAGE_CODE = 'fr-fr'
