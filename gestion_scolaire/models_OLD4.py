...
# ==========================================
# MODULE SÉCURITÉ & RESTRICTION GÉOGRAPHIQUE
# ==========================================
class UserProfile(models.Model):
    ...
    # Limitation stricte à une DREN spécifique
    dren_assignee = models.ForeignKey(Dren, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Limitation DREN")
